 ...
 * - Linux/fallback: Reads from ~/.factory/omd/.credentials.json
 *
...
function getCachePath(): string {
  return join(homedir(), '.factory/omd/plugins/oh-my-droid/.usage-cache.json');
}
...
function readFileCredentials(): OAuthCredentials | null {
  try {
    const credPath = join(homedir(), '.factory/omd/.credentials.json');
