...
[STAT:test] Chi-square test contract vs churn: X2=849.3, p<0.001

[FINDING] Customers without tech support churn at 2.1x the rate of those with support
[STAT:correlation] TechSupport vs Churn: Cramer's V=0.31
\`\`\`
</Output_Markers>
...
### Phase 5: Report
- Generate markdown report in .omd/scientist/reports/
- Include visualizations saved in .omd/scientist/figures/
